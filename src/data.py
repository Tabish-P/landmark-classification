...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([
            ...
            # random gray scale to image helps boundary detection
            transforms.RandomGrayscale(p=0.1),
            # rotate up to 10 degress
            transforms.RandomRotation(10),
            #random/color/brightness changes
    ...
    test_data = datasets.ImageFolder(
        base_path / "test", transform=data_transforms["valid"]
    )
